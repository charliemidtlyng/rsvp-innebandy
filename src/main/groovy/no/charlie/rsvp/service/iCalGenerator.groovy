...
class ICalGenerator {
    ...
    static net.fortuna.ical4j.model.Calendar generateCalendarForEvents(List<Event> events) {
        ...
        icsCalendar.getProperties().add(new ProdId("-//BEKK Innebandy//iCal4j 1.0//EN"))
        ...
        events.each {
            ...
            UidGenerator ug = new UidGenerator(new SimpleHostInfo('innebandy.bekk.no'),"BekkInnebandy${it.id}")
